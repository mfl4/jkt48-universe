...
@section('content')
    <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <h1 class="border-b border-red-700 p-4 text-2xl font-black tracking-tight text-red-700" data-aos="fade-down-left"
            data-aos-delay="200" data-aos-duration="1000" data-aos-mirror="true" data-aos-once="false">
            All
            Members</h1>
        ...
        <section class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
            @foreach ($members as $member)
                <section class="relative" data-aos="fade-down-right" data-aos-delay="{{ $member->generation }}0"
                    ...
                    <section
                        class="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-red-300 lg:aspect-none hover:opacity-75 lg:h-80">
                        <img src="{{ asset('images/fre.png') }}" alt="{{ $member->name }}"
                            class="h-full w-full object-cover object-center lg:h-full lg:w-full">
                    </section>
                    <section
                        class="mt-2 flex justify-between items-center border border-l-8 border-red-300 rounded-r-lg p-4">
                        ...
                        <section class="hover:text-red-700 text-2xl">
